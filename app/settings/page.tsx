  ...
  return (
    <ClientLayout>
      ...
      <div className="min-h-screen relative z-10 text-white p-8">
        ...
        <h1 className="md:text-6xl text-xl lg:text-8xl font-bold text-center text-white relative z-20 pb-6">
  SpaceScape Settings
</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Theme Settings */}
            <div className="bg-black bg-opacity-60 p-8 rounded-lg backdrop-blur-md shadow-lg">
